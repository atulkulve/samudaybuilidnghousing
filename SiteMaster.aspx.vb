...
Partial Class mmsoft_SiteMaster
    ...
    Public Sub CheckSite(ByVal Site)
        ...
        Try
            conn.Open()
            Dim sql As String = "SELECT * FROM Site WHERE SiteName =@Site"
    ...
    Public Function AddData() As Boolean
        ...
        mydate = Today
        If objMid.ExecuteSqlStmt("Insert Into Site (SiteName,Address1,Address2,TelNo,userId,createdDate) values('" & txtSiteName.Text & "','" & txtadd1.Text & "', '" & txtadd2.Text & "','" & txttelno.Text & "','" & Session("USERID") & "','" & mydate & "')") Then
            Return True
        Else
            Return False
        End If
    ...
    Public Function ModifyData() As Boolean
        Dim mydate As New Date
        mydate = Today
        If objMid.ExecuteSqlStmt("Update Site set SiteName='" & txtSiteName.Text & "', Address1= '" & txtadd1.Text & "',Address2 = '" & txtadd2.Text & "',TelNo='" & txttelno.Text & "' where SiteId = " & CInt(txthidden.Text) & "") Then
            Return True
        Else
            Return False
        End If
    ...
    Public Function getSiteData() As DataSet
        ...
        ds = objMid.ExecuteSelectSQL("select * from Site where SiteId='" & txthidden.Text & "'")
        Return ds
    End Function
