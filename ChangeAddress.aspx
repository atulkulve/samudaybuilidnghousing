<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="ChangeAddress.aspx.vb" Inherits="mmsoft_ChangeAddress" %>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:220px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Change Customer Details</span></td>
      ...
      <td style="width: 3px;" background="../softimages/l_bor1.gif"></td>
          <td colspan="3" style="width: 878px;">
              <table width="100%">
                                  ...
                                  <td colspan="4" style="text-align: left">
                                      <table width="100%">
                                          ...
                                          <tr>
                                              ...
                                              <td style="width: 156px">
                                                  <asp:TextBox ID="txtremarks" runat="server" Font-Bold="False" Font-Names="Verdana"
                                                      Font-Size="8pt" ForeColor="#006699" Height="15px" Width="168px"></asp:TextBox></td>
                                              <td style="width: 169px">
                                              </td>
                                              <td style="width: 217px">
                  ...
                  <tr>
                      <td style="width: 690px; height: 20px;">
                  ...
                  <tr>
                      <td style="width: 690px; height: 16px">
