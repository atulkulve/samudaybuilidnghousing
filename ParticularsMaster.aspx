<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="ParticularsMaster.aspx.vb" Inherits="mmsoft_ParticularsMaster" %>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:220px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Particulars Master</span></td>
      ...
      <td style="width: 3px;" background="../softimages/l_bor1.gif"></td>
          <td colspan="3" style="width: 878px;">
              <table width="100%">
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 143px; text-align: left">
                                      <span style="font-size: 10pt; font-family: Verdana"><span style="font-size: 8pt">Particulars
                                          Name</span></span></td>
                                  ...
                                  <table border="0" bordercolor="#006699">
                                      <tr>
                                          <td style="width: 439px; height: 20px; text-align: left">
                                              <span style="font-size: 8pt; font-family: Verdana">Select Particulars</span></td>
                  ...
                  <tr>
                      <td style="width: 358px; height: 16px">
