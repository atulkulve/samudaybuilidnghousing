<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DemandLetter.aspx.vb" Inherits="mmsoft_DemandLetter" %>
                ...
                <table border="0" width="70%">
                    ...
                    <tr>
                        ...
                        <td style="width: 278px">
                            <cc1:GMDatePicker ID="lblLetterdate" runat="server" DisplayMode="Label" MaxDate="2020-12-31"
                                MinDate="1950-01-01" YearDropDownRange="100" DateFormat="dd-MMM-yy">
                            </cc1:GMDatePicker>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 242px">
                            <asp:ImageButton ID="imbSave" runat="server" ImageUrl="~/softimages/print-bt.gif" OnClientClick="return ValidateInput();" /></td>
                        <td style="width: 278px">
                        </td>
                    </tr>
                </table>
        ...
        <table width="100%">
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px; text-align: center">
                    <span style="font-size: 8pt; font-family: Verdana">Registration No. 15520 Date: - 11-06-2004</span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td colspan="6" style="text-align: center">
                    <hr />
                    <span style="font-family: Verdana"><span style="font-size: 10pt">B-6 Basement, D.N.S.
                        Tower. Court Naka Thane(W). Tel. No. 25477296, 25474219<br />
                    </span>
                ...
                <td colspan="2">
                    <span style="font-size: 10pt; font-family: Verdana">Tel. No.
                        <asp:Label ID="lbltelno" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Label"
                            Width="115px" Font-Bold="True"></asp:Label></span></td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 18px; text-align: center">
                    <span style="font-family: Verdana"><span style="font-size: 10pt">Sub:
                    </span>
                        ...
                        <asp:Label ID="lblbeginstagename" runat="server" Font-Names="Verdana" Font-Size="10pt"
                            Text="Label"></asp:Label><span style="font-size: 10pt"> </span>
                        <span><span style="font-size: 10pt">
                            ...
                            <asp:Label ID="lblbuilding" runat="server" Font-Names="Verdana" Font-Size="10pt"
                                Text="Label"></asp:Label><span style="font-size: 10pt"><strong>
                            Area - </strong></span>
                            <asp:Label ID="lblsqft" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Label"></asp:Label><span
                                style="font-size: 10pt">
                            Sq. Ft.</span></span></span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px; text-align: center">
                    <span><span><span style="font-size: 10pt;
                        font-family: Verdana"><strong>&nbsp;</strong></span></span></span></td>
            </tr>
            <tr style="font-size: 10pt; font-weight: bold; font-family: Verdana;">
                <td style="width: 70px">
                </td>
                    ...
                    <p style="text-align: justify">
                        <span><span style="font-size: 10pt; font-family: Verdana">&nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            <asp:Label ID="lblbeginstage" runat="server" Font-Names="Verdana" Font-Size="10pt"
                                Text="Label"></asp:Label><span style="font-size: 10pt; font-family: Verdana"> of Building
                                </span>
                            <asp:Label ID="lblBldgName2" runat="server" Font-Names="Verdana" Font-Size="10pt"
                                Text="Label"></asp:Label><span style="font-size: 10pt; font-family: Verdana">. The amount
                                    to be paid as per </span>
                            <span
                                style="font-size: 10pt; font-family: Verdana"> the schedule is Rs.
                            </span>
                        ...
                        <span style="font-size: 10pt; font-family: Verdana">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            pay the balance amount of Rs.</span><asp:Label ID="lblBalAmt" runat="server" Font-Bold="True"
                                Font-Names="Verdana" Font-Size="10pt" Text="Label"></asp:Label><span style="font-size: 10pt;
                                    font-family: Verdana"> /-<strong>. </strong>as per schedule, within 7 days of receipt
                                    of this letter so that your contribution shall enable us to construct the
                                    <asp:Label ID="lblBldgName3" runat="server" Font-Bold="False" Font-Size="10pt" Text="Label"></asp:Label>
                                    Building as per schedule.Therefore you are requested to kindly co-operate. Thanking you in anticipation.</span></p>
                </td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px">
                    <span style="font-size: 10pt; font-family: Verdana"><strong>
                        <hr />
                        Note: If you find any discrepancy in any amount mentioned above, please come to
                        office with original receipt and get it verified and corrected. If you have any
                        grivances, please feel free to express it in writing.<br />
                        <hr />
                    </strong></span>
                </td>
            </tr>
