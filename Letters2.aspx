<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Letters2.aspx.vb" Inherits="mmsoft_Letters2" %>
        ...
        <table width="100%">
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px; text-align: center">
                    <span style="font-family: Verdana; font-size: 10pt;">Registration No. 15520 Date: - 11-06-20004</span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td colspan="6" style="text-align: center">
                    <hr />
                    <span style="font-family: Verdana"><span style="font-size: 10pt">Ankaleshwariya Bldg,
                        Block No. 5, Ground Floor, Opp Ashwini Motors &amp; Reliance Fresh, Edulji Rd.,
                        Charai, Thane - W.<br />
                        Tel No. 25304219/254052791/25447219</span><br />
            ...
            <tr style="font-size: 12pt">
                ...
                <td style="width: 7177px; height: 21px; text-align: center">
                    <span style="font-family: Verdana"><strong>2nd Letter</strong></span></td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="2">
                    <span style="font-size: 10pt; font-family: Verdana"><strong>To,</strong></span></td>
                <td style="font-weight: bold; font-size: 12pt; width: 1410px">
                </td>
                <td style="font-weight: bold; font-size: 12pt; width: 7177px">
                </td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="2">
                    <span style="font-size: 10pt; font-family: Verdana"><strong>Tel. No. </strong>
                ...
                <td style="font-size: 12pt; width: 7177px">
                </td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="text-align: center">
                    <span style="font-family: Verdana"><span style="font-size: 10pt">Sub: Demand for payment
                        of Outstanding amount</span></span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px; text-align: center">
                    <span style="font-family: Verdana"><span style="font-size: 10pt">Flat No: -<span
                        ...
                        <asp:Label ID="lblbuilding" runat="server" Font-Names="Verdana" Font-Size="10pt"
                            Text="Label"></asp:Label><span style="font-size: 10pt">, Area: - </span>
                        <asp:Label ID="lblsqft" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Label"></asp:Label><span
                            style="font-size: 10pt"> Sq. Ft.</span></span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 70px">
                </td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="1" style="width: 70px; height: 64px">
                </td>
                <td colspan="4" style="height: 64px">
                    <p style="text-align: justify">
                        <span style="font-size: 10pt; font-family: Verdana">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;We want to bring to you kind notice (Please
                            refer to our 1st Letter dated
                            <asp:Label ID="lblLastDate" runat="server" Font-Names="Verdana" Font-Size="10pt" Text="Label" Font-Bold="True"></asp:Label>)
                            that your Total OutStanding is Rs.
                            <asp:Label ID="lbltotalout" runat="server" Font-Bold="True" Font-Size="10pt" Text="Label"></asp:Label><span
                                style="font-size: 10pt"> Plus Interest of Rs. </span>
                            <asp:Label ID="lblinterest" runat="server" Font-Bold="True" Font-Size="10pt" Text="Label"></asp:Label><span
                                style="font-size: 10pt">. Aggregate amount is Rs. </span>
                            <asp:Label ID="lblaggamt" runat="server" Font-Bold="True" Font-Size="10pt" Text="Label"></asp:Label>
                            is due from you<span style="font-size: 10pt">.</span></span></p>
                </td>
                <td colspan="1" style="font-size: 12pt; height: 64px">
                </td>
            </tr>
            <tr style="font-size: 12pt">
                ...
                <td colspan="4" style="height: 21px">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; <span style="font-size: 10pt"><span style="font-family: Verdana">Please arrange
                        to pay this amount with in 7 days of issue of this 2nd Reminder letter.</span></span></td>
            ...
            <tr style="font-size: 12pt">
                ...
                <td style="width: 7177px; height: 21px">
                </td>
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px">
                    <span style="font-size: 10pt; font-family: Verdana"><strong>
                        ...
                        Note 2: If you find any discrepancy in any amount mentioned above, please come to
                        office with original receipt and get it verified and corrected. If you have any
                        g<span style="font-size: 10pt; line-height: 115%; font-family: 'Verdana','sans-serif';
                            ...
                            mso-bidi-language: AR-SA">rievances</span>, please feel free to express it in
                        writing.&nbsp;
                        <br />
                        <hr />
                    </strong></span>
