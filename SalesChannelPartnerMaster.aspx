<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="SalesChannelPartnerMaster.aspx.vb" Inherits="mmsoft_SalesChannelPartnerMaster" %>
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 104%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:272px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Sales Channel Partner Master</span></td>
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 143px; text-align: left">
                                      <span style="font-size: 10pt; font-family: Verdana"><span style="font-size: 8pt">Sales
                                          Channel
                                          Partner Name</span></span></td>
                              ...
                              <tr>
                                  <td style="width: 143px; text-align: left">
                                      <span style="font-size: 8pt; font-family: Verdana">Channel Partner</span></td>
                                  <td style="width: 211px; text-align: left">
                                      <asp:DropDownList ID="drpcp" runat="server" Font-Bold="False" Font-Names="Verdana"
                                  ...
                                  <table border="0" bordercolor="#006699">
                                      <tr>
                                          <td style="width: 439px; height: 20px; text-align: left">
                                              <span style="font-size: 8pt; font-family: Verdana">Select Channel Partner Name</span></td>
