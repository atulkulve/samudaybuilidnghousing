<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="TransactionModifyPayment.aspx.vb" Inherits="mmsoft_TransactModifyPay" %>
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 104%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:242px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Transaction Payment Modify</span></td>
              ...
              <table width="100%">
                              ...
                              <Columns>
                                  <asp:TemplateField>
                                      <ItemTemplate>
                                          ...
                                          <input id="HiddenID" runat="server" type="hidden" value='<%# Bind("Transact_Id") %>' />
                                      </ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Date" SortExpression="User_Name">
                                      <ItemStyle HorizontalAlign="Right" />
                                      <HeaderStyle HorizontalAlign="Center" />
                                      <ItemTemplate>
                                          <asp:Label ID="lblUser67" runat="server" Text='<%# Bind("Transact_Date") %>'></asp:Label>
                                      </ItemTemplate>
                                  </asp:TemplateField>
                  ...
                  <tr>
                      <td style="width: 2283px; height: 22px;">
                          <asp:ImageButton ID="imbEdit" runat="server" ImageUrl="~/softimages/edit_bt.gif" OnClientClick="return ValidateInput();" /></td>
                      ...
                      <td style="width: 2283px">
                          <table>
                              <tr>
                                  ...
                                  <td style="width: 181px">
                                      <cc1:GMDatePicker ID="transactdate" runat="server" DateFormat="d-MMM-yy" DisplayMode="Label"
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <asp:TextBox ID="txtTransactAmt" runat="server"></asp:TextBox></td>
                                  <td style="width: 181px">
                                  </td>
                                  <td style="width: 181px">
                                  </td>
