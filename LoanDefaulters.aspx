<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoanDefaulters.aspx.vb" Inherits="mmsoft_LoanDefaulters" %>
                ...
                <table width="100%">
                    <tr>
                        <td colspan="3" style="height: 21px">
                            <span style="font-size: 8pt; font-family: Verdana"><strong>List of Loans Personal for
                                <asp:Label ID="lblbuilding" runat="server" Font-Bold="True" Text="Label"></asp:Label>
                                building</strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <asp:GridView ID="Grid1" runat="server" CellPadding="4" Font-Names="Verdana" Font-Size="8pt"
                                ForeColor="#333333" GridLines="None" Height="161px">
