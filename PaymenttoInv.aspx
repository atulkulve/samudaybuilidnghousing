<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="PaymenttoInv.aspx.vb" Inherits="PaymenttoInv" %>
...
{
        if(validateEmpty(document.getElementById('ctl00_ContentPlaceHolder2_txtamt'),'Enter amt','Invalid Input in amt'))
        {
   	    if(isNotLetter(document.getElementById('ctl00_ContentPlaceHolder2_txtamt'),'Alphabet in Amount'))
        {
	    if(validateEmpty(document.getElementById('ctl00_ContentPlaceHolder2_txtinstamt'),'Enter amt','Invalid Input in amt'))
        {
   	    if(isNotLetter(document.getElementById('ctl00_ContentPlaceHolder2_txtinstamt'),'Alphabet in Installment Amount'))
   	    {
            return true;
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 104%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="TABLE1" onclick="return TABLE1_onclick()">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:358px; height: 20px;">
            <span style="font-size: 11pt; font-family: Verdana">Payment To Investors Transaction</span></td>
          ...
          <td colspan="3" style="width: 984px;">
              <table width="100%">
                  <tr>
                                          ...
                                          <td colspan="2">
                                              <table width="100%">
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <asp:ImageButton ID="imbOk" runat="server" ImageUrl="~/softimages/ok.gif" OnClientClick="return validateOk();" /></td>
                                                  </tr>
                                              </table>
                                              <asp:Label ID="lblmsg" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
                                                  ForeColor="#FF0000" Text="Label" Visible="False"></asp:Label></td>
                                      </tr>
                                  </table>
                              </asp:View>
                      ...
                      <td style="width: 287px; height: 1px;">
                      </td>
                  </tr>
                  <tr>
