...
Imports System.Math
Partial Class mmsoft_ProvisionalBillLayout
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim total As Double
        dsparti = objMid.ExecuteSelectSQL("Select * from ParticularsProvTable where ReceiptNos=" & Session("ReceiptNos") & "")
        Dim i As Integer
        ...
        ds = objMid.ExecuteSelectSQL("Select * from ProvBillDetails where ReceiptNos=" & Session("ReceiptNos") & "")
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            lblBillDate.Text = Convert.ToDateTime(ReceiptDate.Date).ToString("dd-MMM-yy")
            lblBillDate2.Text = Convert.ToDateTime(ReceiptDate.Date).ToString("dd-MMM-yy")
            ...
            Else
                ...
                lblcheqdate.Text = Convert.ToDateTime(ReceiptDate.Date).ToString("dd-MMM-yy")
                lblcheqdate2.Text = Convert.ToDateTime(ReceiptDate.Date).ToString("dd-MMM-yy")
            End If
        End If
        'myRow = PartiDetails.NewRow()
