<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Admin.master"  CodeFile="brandmaster.aspx.vb" Inherits="brandmaster" %>
...
function ValidateInput()
{
	    ...
	    if(validateEmpty(document.getElementById('ctl00_ContentPlaceHolder2_txtbrand'),'Enter Brand','Invalid Input in Brand'))
        {
            return true;        
        }      
        return false;
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:212px; height: 20px;">
            <span style="font-size: 11pt; font-family: Verdana">Brand Master</span></td>
          ...
          <td colspan="3" style="width: 878px;">
              <table width="100%">
                  ...
                  <tr>
                      <td style="width: 336px">
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 93px; height: 25px; text-align: left">
                                      <strong><span style="font-size: 8pt; font-family: Verdana">Brand Name</span></strong></td>
                                  <td style="height: 25px; text-align: left">
                                      <asp:TextBox ID="txtbrand" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt"
                                  ...
                                  <table border="0" bordercolor="#006699">
                                      <tr>
                                          <td style="width: 439px; height: 20px; text-align: left">
                                              <strong><span style="font-size: 8pt; font-family: Verdana">Select Brand</span></strong></td>
                                          <td style="width: 117px; height: 20px; text-align: left">
                                              <asp:DropDownList ID="drpbrand" runat="server" Font-Bold="False" Font-Names="Verdana"
                  ...
                  <tr>
                      ...
                      <td style="width: 466px; height: 20px;">
                      </td>
