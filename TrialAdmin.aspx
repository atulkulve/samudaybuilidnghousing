<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Admin.master" CodeFile="TrialAdmin.aspx.vb" Inherits="mmsoft_TrialAdmin" %>
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 104%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:308px; height: 20px;">
            <span style="font-size: 11pt; font-family: Verdana">trial</span></td>
	...
	<table  border="0" cellspacing="0" cellpadding="0" style="width: 100%" class="td_bg_1">
      ...
      <tr>
      <td style="width: 3px; height: 25px;" background="../softimages/l_bor1.gif"></td>
          <td colspan="3" style="width: 878px; height: 25px;">
          ...
          <td background="../softimages/low_bor3.gif" style="width: 17px; height: 25px;"></td>
      </tr>
