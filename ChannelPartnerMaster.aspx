<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="ChannelPartnerMaster.aspx.vb" Inherits="mmsoft_ChannelPartnerMaster" %>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:220px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Channel Partner Master</span></td>
      ...
      <td style="width: 3px;" background="../softimages/l_bor1.gif"></td>
          <td colspan="3" style="width: 878px;">
              <table width="100%">
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 143px; text-align: left">
                                      <span style="font-size: 10pt; font-family: Verdana"><span style="font-size: 8pt">Channel
                  ...
                  <tr>
                      <td style="width: 389px; height: 16px">
