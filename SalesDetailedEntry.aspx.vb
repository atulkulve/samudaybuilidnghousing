...
Partial Class mmsoft_SalesDetailedEntry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            objMid.PopulateList(drpcp, "channelp_id", "channelp_name", objMid.ExecuteSelectSQL("select * from tbl_channelpartner_master").Tables(0))
    ...
    Public Function AddSalesEntry() As Boolean
        ...
        mydate = Today
        sql = "INSERT INTO salesDetails (SalesId,SiteId,BldgId,RoomId,SqFt,Rate,FName,LName,SFName,SLName,Add1,Add2,telno,Mobno,email,saledate,Bank,userId,createdDate,installments,gender,dateofbirth,scp_id) VALUES("
        ...
        sql = sql & "'" & txtmobno.Text & "','" & txtemail.Text & "','" & SaleDate.Date & "','" & txtbank.Text & "','" & Session("USERID") & "','" & Now.Date & "','" & drpinstallments.SelectedValue & "','" & drpgender.SelectedValue & "','" & birthdate.Date & "'," & drpscp.SelectedValue & ") "
    ...
    Public Sub installments(ByVal nos As Double, ByVal bookamt As Double, ByVal emiamt As Double)
        ...
        For i = 0 To CDec(drpinstallments.SelectedValue)
            If i = 0 Then
        ...
        Next
        sql = "INSERT INTO tbl_roominstallments_details (installment_name,RoomId,installment_date,installment_value,installment_status) VALUES('Final Payment(15%)',"
        sql = sql & drpFlatNumber.SelectedValue & ",'" & datedl.AddMonths(i - 1).Date & "'," & nos & ",'pending')"
        objMid.ExecuteSqlStmt(sql)
        'lblmsg.Text = xstr
    End Sub
    ...
    Protected Sub drpcp_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles drpcp.SelectedIndexChanged
        'objMid.ClearDropDown(drpscp)
        objMid.PopulateList(drpscp, "scp_id", "scp_name", objMid.ExecuteSelectSQL("select * from tbl_saleschannelpartner_master where channelp_id='" & drpcp.SelectedValue & "'").Tables(0))
    End Sub
End Class
