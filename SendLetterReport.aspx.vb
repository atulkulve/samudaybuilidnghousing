...
Partial Class mmsoft_SendLetterReport
    ...
    Protected Sub imbSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSave.Click
        Session("BuildId") = drpBuilding.SelectedValue
        Session("CharSerial") = drpLetter.SelectedItem.Text
        lblBldg.Text = drpBuilding.SelectedItem.Text
        lblSite.Text = drpLetter.SelectedItem.Text
