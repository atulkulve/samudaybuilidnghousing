<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DemandLetterwithoutInt.aspx.vb" Inherits="mmsoft_DemandLetter" %>
    ...
    <div>
        ...
        <table width="100%">
            ...
            <tr style="font-size: 12pt">
                ...
                <td style="width: 7565px; text-align: center">
                        ...
                        <span style="font-size: 10pt; font-family: Verdana">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            pay the balance amount of Rs.</span><asp:Label ID="lblBalAmt" runat="server" Font-Bold="True"
                                Font-Names="Verdana" Font-Size="10pt" Text="Label"></asp:Label><span style="font-size: 10pt;
                                    font-family: Verdana"> /-<strong>. </strong>as per schedule,
            ...
            <tr style="font-size: 12pt">
                <td colspan="6" style="height: 21px">
                    <span style="font-size: 10pt; font-family: Verdana">
                        ...
                        <strong>Note 1: Interest has been strictly enforced on outstanding amount as on 1<sup>st</sup>
                        Sept 10 with 21% p.a.<br />
                            Note 2: Please confirm the Amount Paid, if any discrepancy inform office within
                            15 days or your account will be considered confirmed.&nbsp;</strong>
                        <hr style="font-weight: bold" />
                    </span>
                </td>
            </tr>
