<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="ModifyPaymentEntry.aspx.vb" Inherits="mmsoft_ModifyPaymentEntry" %>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:158px; height: 21px;">
            <span style="font-size: 11pt; font-family: Verdana">Payment Entry</span></td>
