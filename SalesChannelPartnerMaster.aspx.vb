...
Partial Class mmsoft_SalesChannelPartnerMaster
    ...
    Public Sub CheckSite(ByVal Site)
        ...
        Try
            conn.Open()
            Dim sql As String = "SELECT * FROM tbl_saleschannelpartner_master WHERE scp_name =@Site"
    ...
    Public Function AddData() As Boolean
        ...
        mydate = Today
        If objMid.ExecuteSqlStmt("Insert Into tbl_saleschannelpartner_master (scp_name,channelp_id) values('" & txtSiteName.Text & "','" & drpcp.SelectedValue & "')") Then
            Return True
        Else
            Return False
        End If
    ...
    Protected Sub imbSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSave.Click
        ...
        If mnuMenu.Items(1).Enabled = True Then
            ...
            Else
                lblmsg.Text = "Sales Channel Partner Name already Exists!"
            End If
        Else
            If MyFlag = True Then
                If ModifyData() Then
                    ...
                    objMid.PopulateList(drpSiteName, "scp_id", "scp_name", objMid.ExecuteSelectSQL("select * from tbl_saleschannelpartner_master").Tables(0))
                Else
            ...
            Else
                lblmsg.Text = "Sale Channel Partner Name already Exists!"
            End If
    ...
    Private Sub clearcontrols()
        txtSiteName.Text = ""
        drpcp.SelectedIndex = 0
    End Sub
    Public Function ModifyData() As Boolean
        Dim mydate As New Date
        mydate = Today
        If objMid.ExecuteSqlStmt("Update tbl_saleschannelpartner_master set channelp_id='" & drpcp.SelectedValue & "', scp_name='" & txtSiteName.Text & "' where scp_id = " & CInt(txthidden.Text) & "") Then
            Return True
        Else
            Return False
        End If
    ...
    Public Function getSiteData() As DataSet
        ...
        ds = objMid.ExecuteSelectSQL("select * from tbl_saleschannelpartner_master where scp_id='" & txthidden.Text & "'")
        Return ds
    End Function
    Protected Sub imbedit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbedit.Click
        ...
        If Not ds Is Nothing Then
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtSiteName.Text = ds.Tables(0).Rows(0)("scp_name").ToString()
                drpcp.SelectedValue = ds.Tables(0).Rows(0)("channelp_id").ToString()
