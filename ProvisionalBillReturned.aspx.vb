...
Partial Class mmsoft_Letters
    ...
    Public Sub PopulateForm(ByVal RoomID As Integer)
        ...
        Dim receiptno As String = Session("ReceiptNos")

        Dim ds1 As New DataSet
        ds1 = objMid.ExecuteSelectSQL("SELECT * from ProvBillDetails where ReceiptNos = " & receiptno & "")
        Dim dt1 As DataTable
        dt1 = ds1.Tables(0)

        lblbank.Text = dt1.Rows(0)("BankName").ToString()
        lblchequeno.Text = dt1.Rows(0)("OtherDetails").ToString()
        lblreceiptnos.Text = receiptno
        lblreceiptdate.Text = Convert.ToDateTime(dt1.Rows(0)("Chequedate").ToString()).ToString("dd-MMM-yy")

        lbldate.Text = Convert.ToDateTime(Now).ToString("dd-MMM-yy")
