<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="payment_toInvdetails.aspx.vb" Inherits="payment_toInvdetails" %>
                  ...
                  <tr>
                          ...
                          <table border="0"  style="font-size: 12pt; width: 680px; height: 50px;
                              ...
                              <tr style="color: #000000">
                                  <td align="left" style="width: 260px;">
                                      <span style="font-size: 8pt; font-family: Verdana"><strong>N<span>ame</span></strong></span></td>
                                  <td align="left" style="font-size: 12pt; width: 1009px; font-family: Times New Roman;">
                                      <asp:DropDownList ID="drpname" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                          ...
                                          Font-Bold="False" Font-Names="Verdana" Font-Size="8pt" ForeColor="#006699" Height="36px"
                                          Width="244px">
                              ...
                              <tr style="font-size: 12pt; color: #000000; font-family: Times New Roman">
                                  ...
                                  <td align="left" style="font-size: 12pt; width: 1009px; color: #000000; font-family: Times New Roman;
                                      height: 7px">
                                      <asp:TextBox ID="txtaddr" runat="server" AutoPostBack="True" Enabled="False" Font-Bold="False"
                                          Font-Names="Verdana" Font-Size="8pt" ForeColor="#006699" Height="55px" Rows="2"
                                          TextMode="MultiLine" Width="239px"></asp:TextBox></td>
                              </tr>
                          </table>
                      </td>
                      <td style="width: 390px;">
                          ...
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conMM %>"
                              SelectCommand="SELECT pi_id, pay_date, amount, chq_no, chq_date, chq_bank, chq_branch FROM actual_payto_investor WHERE (it_id = @it_id)">
                              <SelectParameters>
                          ...
                          &nbsp;<br />
                              <asp:GridView ID="transactionGrid" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField DataField="aggrement_date" HeaderText="Agreement Date" SortExpression="aggreement_date" />
                                      <asp:BoundField DataField="paytoinv_tenure" HeaderText="Scheme Tenure" SortExpression="paytoinv_tenure" />
                                      <asp:BoundField DataField="due_date" HeaderText="Due Date" SortExpression="due_date" />
                                      <asp:BoundField DataField="inst_amount" HeaderText="Installment" SortExpression="installment" />
                              ...
                              <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:JIDNYASADATAConnectionString %>"
                                  SelectCommand="SELECT paytoinv_id, it_id, aggrement_date, paytoinv_tenure, due_date, amount, inst_amount, Is_Issued, cust_id, cust_name, scheme_id, scheme_name FROM payto_investors_view WHERE (cust_name = @cust_name)" ProviderName="<%$ ConnectionStrings:JIDNYASADATAConnectionString.ProviderName %>">
                                  <SelectParameters>
                      ...
                      <td style="width: 300px;">
                          <asp:MultiView ID="MultiView1" runat="server">
                              ...
                              <table border="0"  style="width: 685px; height: 74px; ">
                                  <tr>
                                      ...
                                      <td style="width: 51px; height: 23px; text-align: left">
                                          <asp:TextBox ID="txtchno" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="10pt"
                                              ForeColor="#006699" Width="157px"></asp:TextBox></td>
                                  </tr>
                                  <tr>
                                      <td style="width: 90px; height: 6px; text-align: left">
                                  ...
                                  <tr>
                                      <td style="width: 90px; height: 15px; text-align: left">
                                  ...
                                  <tr>
                                      <td style="width: 90px; height: 4px; text-align: left">
