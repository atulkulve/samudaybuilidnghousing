<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Admin.master" CodeFile="AccountHead.aspx.vb" Inherits="mmsoft_AccountHead" %>
...
function ValidateInput()
{
	    ...
	    if(validateEmpty(document.getElementById('ctl00_ContentPlaceHolder2_txtaccounthead'),'Enter Account Head','Invalid Input in Account Head'))
        {
            return true;        
        }      
        return false;
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 104%">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:269px; height: 20px;">
            <span style="font-size: 11pt; font-family: Verdana">Account Head Master</span></td>
              ...
              <table width="100%">
                  ...
                  <tr>
                      <td style="width: 637px">
                          ...
                          <table border="0" bordercolor="#006699" width="100%">
                              <tr>
                                  <td style="width: 500px; height: 25px; text-align: left">
                                      <strong><span style="font-size: 8pt; font-family: Verdana">Account Head Name</span></strong></td>
                                  <td style="height: 25px; text-align: left; width: 275px;">
                                      <asp:TextBox ID="txtaccounthead" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt"
                                  ...
                                  <table border="0" bordercolor="#006699" width="100%">
                                      <tr>
                                          <td style="width: 156px; height: 20px; text-align: left">
                                              <strong><span style="font-size: 8pt; font-family: Verdana">Select Account Head</span></strong></td>
                          ...
                          <asp:Label ID="lblmsg" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" ForeColor="Red"></asp:Label></td>
                      <td style="width: 466px">
