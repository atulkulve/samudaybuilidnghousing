<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="FlatType.aspx.vb" Inherits="mmsoft_FlatType" %>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:220px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Flat Type Master</span></td>
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 189px; text-align: left;">
                                      <span style="font-size: 10pt; font-family: Verdana"><span style="font-size: 8pt">Flat
                                          Type</span></span></td>
                                  <td style="text-align: left; width: 247px;">
                                      <asp:TextBox ID="txtFlatTypeName" runat="server" Font-Bold="False" Font-Names="Verdana"
                                          Font-Size="8pt" ForeColor="#006699" Height="15px" Width="166px"></asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td style="width: 189px; text-align: left">
                                  ...
                                  <td style="width: 247px; text-align: left">
                                      <asp:TextBox ID="txtsqft" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt"
                                          ForeColor="#006699" Height="15px" Width="166px"></asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td style="width: 189px; text-align: left">
                                      <span style="font-size: 8pt; font-family: Verdana">Other Charges</span></td>
                                  <td style="width: 247px; text-align: left">
                                      <asp:TextBox ID="txtaddCharges" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt"
                                          ForeColor="#006699" Height="15px" Width="166px"></asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td style="width: 189px; text-align: left">
                                      <span style="font-size: 8pt; font-family: Verdana">Booking Amt</span></td>
                                  <td style="width: 247px; text-align: left">
                                      <asp:TextBox ID="txtbookamt" runat="server" Font-Bold="False" Font-Names="Verdana"
                                          Font-Size="8pt" ForeColor="#006699" Height="15px" Width="168px"></asp:TextBox></td>
                              </tr>
                              <tr>
                                  <td style="width: 189px; text-align: left">
                                      <span style="font-size: 8pt; font-family: Verdana">EMI Amt</span></td>
                                  <td style="width: 247px; text-align: left">
                                      <asp:TextBox ID="txtemiamt" runat="server" Font-Bold="False" Font-Names="Verdana"
                                          Font-Size="8pt" ForeColor="#006699" Height="15px" Width="168px"></asp:TextBox></td>
                              </tr>
                              <tr>
                                  ...
                                  <table border="0" bordercolor="#006699">
                                      <tr>
                                          <td style="width: 146px; height: 20px; text-align: left">
                                              <span style="font-size: 8pt; font-family: Verdana">Select Flat Type</span></td>
                                          <td style="width: 117px; height: 20px; text-align: left">
                                              <asp:DropDownList ID="drpFlatTypeName" runat="server" Font-Bold="False" Font-Names="Verdana"
