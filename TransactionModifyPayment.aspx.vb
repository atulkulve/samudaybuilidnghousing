...
Partial Class mmsoft_TransactModifyPay
    ...
    Protected Sub imbSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSave.Click
        ...
        sql = "update tbl_Transaction_Details set Transact_Date='" & transactdate.Date & "',ParticularsId='" & drpParticulars.SelectedValue & "',Transact_Amt='" & Val(txtTransactAmt.Text) * -1 & "' where Transact_Id = " & TransactId & ""
        objMid.ExecuteSqlStmt(sql)
        clearcontrols()
        ...
        For Each gvRow As GridViewRow In gvInterest.Rows
            ...
            If ChkBox.Checked = True Then
                If gvRow.RowType = DataControlRowType.DataRow Then
                    ...
                    txtTransactAmt.Text = Val(ds.Tables(0).Rows(0)("Transact_Amt").ToString) * -1
                    Session("Edit") = "True"
                End If
            End If
        Next
