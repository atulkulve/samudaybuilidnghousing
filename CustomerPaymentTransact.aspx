<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CustomerPaymentTransact.aspx.vb" Inherits="mmsoft_CustomerPayment" %>
                    ...
                    <tr>
                        <td colspan="3">
                            <table width="100%">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <span style="font-size: 8pt; font-family: Verdana"><strong>First Stage Installments
                                            Pending</strong></span></td>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        ...
                                        <asp:SqlDataSource ID="sqlinstallments" runat="server" ConnectionString="<%$ ConnectionStrings:conMM %>"
                                            ...
                                            <SelectParameters>
                                                <asp:SessionParameter Name="RoomID" SessionField="RoomIid" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <span style="font-size: 8pt; font-family: Verdana">Payment of Other Outstandings</span></td>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <asp:GridView ID="gvTransact" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Transact_Date" 
                                                        DataFormatString="{0:dd-MMM-yy}" 
                                                        HeaderText="Date"                                                    
                                                        SortExpression="Payment Date"                                                     
                                                        HtmlEncode="False">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <asp:GridView ID="gvOutstanding" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Verdana"
                                            Font-Size="8pt" ForeColor="Black" GridLines="Vertical" Width="100%">
                                            <FooterStyle BackColor="#CCCC99" CssClass="td_bg_selected3" />
                                            <Columns>
