...
Partial Class mmsoft_BuildingLoanDefaulters
    ...
    Protected Sub imbSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSave.Click
        ...
        ds = objMid.ExecuteSelectSQL("SELECT TOP 100 PERCENT SalesId, SiteId, BldgId, RoomId, SqFt, Rate, FName, LName, SFName, SLName, Add1, Add2, telno, Mobno, email, saledate,Bank FROM dbo.salesDetails WHERE (BldgId = " & drpBuilding.SelectedValue & ") and Bank <> '' or Bank <> null ORDER BY RoomId")
        Dim dt As DataTable
        dt = ds.Tables(0)
