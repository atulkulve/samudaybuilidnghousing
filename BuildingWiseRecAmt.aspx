<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BuildingWiseRecAmt.aspx.vb" Inherits="mmsoft_BuildingWiseRecAmt" %>
                ...
                <table width="100%">
                    <tr>
                        <td colspan="3" style="height: 21px">
                            <span style="font-size: 8pt; font-family: Verdana"><strong>Buildingwise Collection Report as on&nbsp;
                                ...
                                <asp:Label ID="lblyear" runat="server" Text="Label"></asp:Label></strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="3">
