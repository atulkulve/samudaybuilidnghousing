<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/SFA.master" CodeFile="StageDetails.aspx.vb" Inherits="mmsoft_StageDetails" %>
...
function validateOk()
{
        if(validateDropDown(document.getElementById('ctl00_ContentPlaceHolder2_drpStageName'),'Select Stage'))
        {
            return true;
        }
    return false;
...
{
	    if(validateEmpty(document.getElementById('ctl00_ContentPlaceHolder2_txtStageName'),'Enter Stage','Invalid Input in Stage'))
        {
               return true;        
        }              
        return false;
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../softimages/head_cen_bg.jpg" class="Title21" style="width:220px; height: 20px;">
            <span style="font-size: 10pt; font-family: Verdana">Stage Master</span></td>
      ...
      <td style="width: 3px;" background="../softimages/l_bor1.gif"></td>
          <td colspan="3" style="width: 878px;">
              <table width="100%">
                  ...
                  <tr>
                      <td style="width: 433px">
                          ...
                          <table border="0" bordercolor="#006699">
                              <tr>
                                  <td style="width: 143px; height: 25px; text-align: left">
                                      <span style="font-size: 10pt; font-family: Verdana"><span style="font-size: 8pt">Stage
                                          Name</span></span></td>
                                  <td style="height: 25px; text-align: left; width: 211px;">
                                      <asp:TextBox ID="txtStageName" runat="server" Font-Bold="False" ForeColor="#006699" Height="15px"
                              ...
                              <asp:View ID="View2" runat="server">
                                  <table border="0" bordercolor="#006699">
                                      <tr>
                                          <td style="width: 137px; height: 20px; text-align: left">
                                              <span style="font-size: 8pt; font-family: Verdana">Select Stage</span></td>
                                          <td style="width: 267px; height: 20px; text-align: left">
                                              <asp:DropDownList ID="drpStageName" runat="server" Font-Bold="False" Font-Names="Verdana"
                                                  Font-Size="8pt" ForeColor="#006699" Height="20px" Width="266px">
                                              </asp:DropDownList></td>
                                      </tr>
                                      <tr>
                  ...
                  <tr>
                      <td style="width: 433px; height: 16px">
